...
public class IconPackHelper {
	...
	public boolean isIconPackLoaded() {
		return mLoadedIconPackResource != null && mLoadedIconPackName != null && mIconPackResources != null;
	}
	...
	public int getResourceIdForActivityIcon(ActivityInfo info) {
		...
		String drawable;
		try {
			drawable = mIconPackResources.get(info.packageName.toLowerCase() + "." + info.name.toLowerCase());
		} catch (NullPointerException e) {
			drawable = mIconPackResources.get(info.packageName + "." + info.name);
		}
		if (drawable == null) {
