...
class IconPackHelper {
    ...
    private fun loadResourcesFromXmlParser(parser: XmlPullParser, iconPackResources: MutableMap<String, String?>) {
        while (parser.next() != XmlPullParser.END_DOCUMENT) {
            ...
            if (name.equals(ICON_MASK_TAG, ignoreCase = true) || name.equals(ICON_UPON_TAG, ignoreCase = true)) {
    ...
    private fun getIconPackResourcesNew(context: Context?, packageName: String?): Map<String, String?>? {
        if (TextUtils.isEmpty(packageName)) {
            return null
        }
    ...
    private fun loadApplicationResources(context: Context?, iconPackResources: MutableMap<String, String?>, packageName: String?) {
    ...
    fun getResourceIdForActivityIcon(info: ActivityInfo): Int {
        ...
        var drawable: String?
        drawable = try {
            mIconPackResources!![info.packageName.lowercase(Locale.getDefault()) + "." + info.name.lowercase(Locale.getDefault())]
